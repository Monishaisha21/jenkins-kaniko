       ...
       script {
              ...
              ])
              {
               sh '''
                  ...
                  git clone https://oauth2:${REPO_PRIVATE_TOKEN}@github.com/Monishaisha21/jenkins-kaniko.git
                  ls
        ...
        container(name: 'kaniko', shell: '/busybox/sh') {
          sh '''#!/busybox/sh
             ...
             ls
            /kaniko/executor --context `pwd` --destination monishaisha210898/kaniko:${BUILD_NUMBER}
          '''
        }
